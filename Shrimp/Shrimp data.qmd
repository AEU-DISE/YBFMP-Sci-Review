...
2.  Lump all shrimp into a single plus count (don't speciate) but add a section to datasheet to mark which shrimp species were present.
...
3.  Include counts for other bycatch, such as crayfish and tadpoles.
