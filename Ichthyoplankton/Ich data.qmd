...
-   January sampling doesn't seem valuable - would be more worthwhile to sample in July and possibly August

    -   if we are focused on native species, maybe just Feb-May...or possible buffer more depending on how we think climate change may affect things given temperatures role in spawning timing

## Recommendation:

1.  Extend sampling through August. Consider dropping January, but wait first to see if earlier flooding with Big Notch influences the timing of larval fish presence (suggest 3 years of continued January sampling).

    -   Extending through August allows us to capture full wave of larval fish in the bypass, which may change in the future with restoration projects and/or climate change.

    -   January currently has very low catch, likely not worth the effort and cost but provides a good bookend and probably good to continue through the first few years of Big Notch operations.
